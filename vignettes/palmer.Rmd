...
author: "Jin Hyun Nam$^1$, Daniel couch$^1$, Willian A. da Silveira$^{2,3}$, Zhenning Yu$^1$, and Dongjun Chung$^1$  
...
$^3$Center for Genomic Medicine, Medical University of South Carolina, Charleston, SC, USA."
date: "April 12, 2019"
...
We are now ready to fit a PALMER using binary matrix and pathway information described above (sdata and pathway).
